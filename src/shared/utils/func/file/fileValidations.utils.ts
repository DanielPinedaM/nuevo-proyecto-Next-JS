...
import { ISendId } from "@/shared/components/dialog/uploadFile/models/interfaces/upload-file.interfaces";
import { listFormat } from "@/shared/utils/func/general.utils";
...
interface IValidateMultipleFiles {
  files: FileWithPath[];
