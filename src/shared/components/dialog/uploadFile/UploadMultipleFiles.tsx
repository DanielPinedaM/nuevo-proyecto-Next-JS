...
"use client";
import Header from "@/shared/components/dialog/HeaderDialog";
...
import DragAndDrop from "@/shared/components/dialog/uploadFile/textAndButtons/dragAndDrop";
...
import { validateId, validateMultipleFiles } from "@/shared/utils/func/file/fileValidations.utils";
...
import { IUploadFile } from "@/shared/components/dialog/uploadFile/models/interfaces/upload-file.interfaces";
        ...
        <section className={`${globalTailwindStyle.dialog.container.content}`}>
          ...
          {acceptedFiles && acceptedFiles?.length > 0 && (
            <div className="flex justify-end mt-2">
              <button onClick={onClickDeleteAllFiles} className="btn btn-secondary btn-background">
                <MdDeleteSweep />
