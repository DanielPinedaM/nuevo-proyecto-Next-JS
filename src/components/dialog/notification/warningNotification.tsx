...
export default function warningNotification(
  ...
  if (!isString(message)) {
    console.error(
      "❌ error - warningNotification - react-hot-toast necesita el mensaje tipo string"
    );
    return;
  }
  ...
  if (String(message).trim() === "") {
    console.error(
      "❌ error - warningNotification - react-hot-toast - el mensaje no puede ser un string vacio ''"
    );
    return;
  }
