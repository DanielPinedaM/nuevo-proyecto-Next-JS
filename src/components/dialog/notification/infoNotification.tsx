...
export default function infoNotification(message: string): void {
  if (!isUseClient()) {
    console.error("❌ error - infoNotification - react-hot-toast se tiene q usar en componente cliente 'use client'");
    return;
  }
  ...
  if (String(message).trim() === "") {
    console.error("❌ error - infoNotification - react-hot-toast - el mensaje no puede ser un string vacio ''");
    return;
  }
